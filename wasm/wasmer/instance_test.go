...
func TestRegisterFunc(t *testing.T) {
	...
	assert.Nil(t, ins.RegisterFunc("TestRegisterFuncNamespace", "funcName", func(f api.WasmInstance) {}))

	assert.Nil(t, ins.Start())

	assert.Equal(t, ins.RegisterFunc("TestRegisterFuncNamespace", "funcName", func(f api.WasmInstance) {}), ErrInstanceAlreadyStart)
}
